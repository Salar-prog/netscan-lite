    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <aside className="w-64 bg-teal-800 text-white flex flex-col">
        <div className="px-6 py-5 border-b border-teal-700">
          <h1 className="text-xl font-bold tracking-tight">ns-lite</h1>
          <p className="text-xs text-teal-300 mt-0.5">IP Discovery Dashboard</p>
        </div>
        ...
        <div className="px-4 py-4 border-t border-teal-700">
          <div className="flex items-center justify-between">
            <span className="text-xs text-teal-300 truncate">{user}</span>
            <button
